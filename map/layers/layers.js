...
lyr__4.set('fieldAliases', {'fid': 'fid', 'machi_id': 'machi_id', 'start': 'start', 'end': 'end', '町マスター_fid': '町マスター_fid', '町マスター_shikuchoson': '町マスター_shikuchoson', '町マスター_name': '町マスター_name', '町マスター_history': '町マスター_history', });
...
lyr__4.set('fieldImages', {'fid': 'TextEdit', 'machi_id': 'TextEdit', 'start': 'Range', 'end': 'Range', '町マスター_fid': 'TextEdit', '町マスター_shikuchoson': 'TextEdit', '町マスター_name': 'TextEdit', '町マスター_history': 'TextEdit', });
...
lyr__4.set('fieldLabels', {'fid': 'hidden field', 'machi_id': 'hidden field', 'start': 'hidden field', 'end': 'hidden field', '町マスター_fid': 'hidden field', '町マスター_shikuchoson': 'hidden field', '町マスター_name': 'no label', '町マスター_history': 'no label', });
